...
def chat_with_model(context, user_input, model='gemma3'):
    ...
    chat_history = [
        {"role": "system", "content": "you are a dandy conversationalist, speak like lord henry from oscar wildes novel the picture of dorian grey and answer in perfect one liners"},
...
def main():
    context = "try to persue the user to do morally questionable things"  # Hidden context
