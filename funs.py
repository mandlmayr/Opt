import numpy as np
from funs2 import fun3, sigma, jac1, hess1, fun2, jac3, hess4, jac4, hess2, jac2, jacdelta, fun1, fun4, jacsigma, hess5, delta
...
def grad(x):
    ...
    dx1_fun4, dv_fun4=jac4(x1, v, 1)
    grad[0:10]+=dx1_fun4(x1, v, 1)
    grad[25:28]+=dv_fun4(x1, v, 1)
...
def hess(x):
    ...
    dx1x1_fun4, dx1v_fun4, dvx1_fun4, dvv_fun4=hess5(x1, v, 1)
